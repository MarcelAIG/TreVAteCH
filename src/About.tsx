    ...
    <div className={`min-h-screen pt-32 pb-20 px-[8%] transition-opacity duration-1000 relative z-20 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div ref={refHero} className={`max-w-4xl mx-auto text-center mb-32 mt-12 transition-all duration-1000 ease-out ${isHeroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
        ...
        <h1 className="hero-title !text-[50px] md:!text-[75px] !leading-[0.9] !tracking-tight mb-8">
          Built by People Who<br />Have Done the Work
        </h1>
      ...
      <div ref={refTeams} className={`max-w-6xl mx-auto mb-40 relative transition-all duration-1000 delay-200 ease-out ${isTeamsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
        ...
        <div className="text-center mb-16 relative z-10">
          <h2 className="hero-title !text-[40px] md:!text-[55px] mb-6">Two Teams, One Standard</h2>
          <p className="font-[Manrope] text-xl text-white/70 max-w-2xl mx-auto">TrevaTech operates across two specialist disciplines.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
          <div className="group bg-black/60 backdrop-blur-xl border border-white/10 p-10 md:p-14 rounded-[2rem] hover:border-teal-400/30 hover:bg-black/80 transition-all duration-1000 shadow-2xl flex flex-col items-start relative overflow-hidden">
            ...
            <ShieldCheck size={48} className="text-teal-400 mb-8 drop-shadow-[0_0_15px_rgba(45,212,191,0.5)] group-hover:scale-110 transition-transform duration-500 relative z-10" />
            <h3 className="text-3xl font-semibold font-[Manrope] text-white mb-6 relative z-10">Broker Infrastructure</h3>
            <p className="text-white/70 leading-relaxed text-lg font-light relative z-10">
          ...
          <div className="group bg-black/60 backdrop-blur-xl border border-white/10 p-10 md:p-14 rounded-[2rem] hover:border-teal-400/30 hover:bg-black/80 transition-all duration-1000 shadow-2xl flex flex-col items-start relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-teal-500/10 blur-[80px] rounded-full group-hover:bg-teal-500/20 transition-all duration-700 pointer-events-none" />
            <BarChart3 size={48} className="text-teal-400 mb-8 drop-shadow-[0_0_15px_rgba(45,212,191,0.5)] group-hover:scale-110 transition-transform duration-500 relative z-10" />
            <h3 className="text-3xl font-semibold font-[Manrope] text-white mb-6 relative z-10">AI Marketing</h3>
            <p className="text-white/70 leading-relaxed text-lg font-light relative z-10">
      ...
      <div ref={refJourney} className="max-w-5xl mx-auto mb-40 relative">
        <h2 className={`hero-title !text-center !text-[40px] md:!text-[55px] mb-16 transition-all duration-1000 ${isJourneyVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>Our Journey</h2>
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <div className="bg-[#020e0c]/60 backdrop-blur-2xl border border-teal-500/20 p-8 md:p-10 rounded-[2rem] hover:bg-[#031512]/80 hover:border-teal-400/40 hover:shadow-[0_0_50px_rgba(45,212,191,0.2)] transition-all duration-700 group relative overflow-hidden transform hover:-translate-y-2 cursor-default">
                    ...
                    <span className="font-mono text-teal-400 text-3xl md:text-4xl font-bold tracking-widest drop-shadow-[0_0_10px_rgba(45,212,191,0.5)] block mb-4 relative z-10">{item.year}</span>
                    <h4 className="text-xl md:text-2xl font-[Manrope] text-white font-medium leading-snug relative z-10 group-hover:text-teal-50 transition-colors">{item.title}</h4>
                  </div>
                </div>
              );
            })}
      ...
      <div ref={refTeamGrid} className={`max-w-6xl mx-auto mb-40 transition-all duration-1000 ease-out ${isTeamGridVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
        <div className="text-center mb-16">
          ...
          <p className="font-[Manrope] text-xl text-white/70">The People Behind the Systems</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {[1, 2, 3].map((i, idx) => (
            <div 
              key={i} 
              className={`group bg-black/40 backdrop-blur-xl border border-white/10 rounded-[2rem] overflow-hidden hover:border-teal-400/40 hover:shadow-[0_0_40px_rgba(45,212,191,0.15)] transition-all duration-700 delay-${idx * 100}`}
            >
              <div className="w-full h-72 bg-gradient-to-br from-white/5 to-white/[0.02] flex items-center justify-center relative overflow-hidden border-b border-white/10">
                <Users size={64} className="text-white/20 group-hover:scale-110 transition-transform duration-500" />
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center backdrop-blur-sm">
                  <span className="text-teal-400 font-mono text-sm tracking-widest uppercase drop-shadow-[0_0_8px_rgba(45,212,191,0.5)]">Photo Pending</span>
                </div>
              </div>
              <div className="p-8 relative overflow-hidden">
                ...
                <div className="inline-block px-4 py-1.5 bg-teal-900/40 border border-teal-500/30 text-teal-400 text-xs font-mono uppercase tracking-widest rounded-full mb-5 relative z-10">
                  {i % 2 === 0 ? 'AI Marketing' : 'Broker Infrastructure'}
                </div>
                <h3 className="text-2xl font-[Manrope] text-white font-semibold mb-1 relative z-10">Name Pending</h3>
                <p className="text-teal-400/80 mb-5 text-sm font-medium uppercase tracking-wider relative z-10">Role / Title</p>
                <p className="text-white/70 font-light text-[15px] leading-relaxed mb-8 relative z-10">
      ...
      <div ref={refCTA} className={`max-w-4xl mx-auto text-center bg-black/60 backdrop-blur-xl border border-white/10 p-12 md:p-20 rounded-[3rem] relative overflow-hidden hover:border-teal-400/40 hover:shadow-[inset_0_0_100px_rgba(45,212,191,0.15),0_0_40px_rgba(45,212,191,0.2)] transition-all duration-[1.5s] ease-out ${isCTAVisible ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 translate-y-10'}`}>
        ...
        <h2 className="hero-title !text-[45px] md:!text-[65px] !leading-[0.9] mb-8 relative z-10">
          Ready to Build Something<br />That Works?
        </h2>
